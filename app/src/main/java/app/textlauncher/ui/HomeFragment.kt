...
import app.textlauncher.databinding.FragmentHomeBinding
import app.textlauncher.helper.expandNotificationDrawer
import app.textlauncher.helper.getChangedAppTheme
import app.textlauncher.helper.getUserHandleFromString
import app.textlauncher.helper.isPackageInstalled
import app.textlauncher.helper.openAlarmApp
import app.textlauncher.helper.openCalendar
import app.textlauncher.helper.openCameraApp
import app.textlauncher.helper.openDialerApp
import app.textlauncher.helper.openSearch
import app.textlauncher.helper.setPlainWallpaperByTheme
import app.textlauncher.helper.showToast
import app.textlauncher.listener.OnSwipeTouchListener
import app.textlauncher.listener.ViewSwipeTouchListener
